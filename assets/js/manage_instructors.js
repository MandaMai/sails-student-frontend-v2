(function(){
      ...
      $(function(){
        ...
        addInstructorButton.click(function(){
          ...
          $("#instructorTable").on("click", "#editButton_instructor", function(e){
        ...
        $("#instructorTable").on("click", "#deleteButton_instructor", function(e){
          let recordId = $(this).data("instructorid")
          $("#deleteConfirm_instructor").dialog({
